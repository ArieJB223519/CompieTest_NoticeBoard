...
- Create Angular project with ng: `ng new compietest_noticeboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`compietest_noticeboard.client.esproj`).
